...
/* Private defines -----------------------------------------------------------*/
#define IR_SLOT1_Pin GPIO_PIN_0
#define IR_SLOT1_GPIO_Port GPIOA
#define IR_SLOT2_Pin GPIO_PIN_1
#define IR_SLOT2_GPIO_Port GPIOA
#define IR_ENTRY_Pin GPIO_PIN_2
